...
public class TrilliardDescription implements INumberDescription{
    ...
    public String numberDescription(int number) {
        ...
        if (charArray[1] != '1') {
            switch (charArray[2]) {
                ...
                case '8':
                case '9':
                    return result.append(" ").append("Триллионов").toString();
                case '1': return result.append(" ").append("Триллион").toString();
                case '2':
                case '3':
                case '4':
                    return result.append(" ").append("Триллиона").toString();
            }
        } else {
            return result.append(" ").append("Триллионов").toString();
        }
