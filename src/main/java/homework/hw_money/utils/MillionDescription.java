...
public class MillionDescription implements INumberDescription{
    @Override
    public String numberDescription(int number) {
        ...
        if (charArray[1] != '1') {
            switch (charArray[2]) {
                ...
                case '8':
                case '9':
                    return result.append(" ").append("Миллионов").toString();
                case '1': return result.append(" ").append("Миллион").toString();
                case '2':
                case '3':
                case '4':
                    return result.append(" ").append("Миллиона").toString();
            }
        } else {
            return result.append(" ").append("Миллионов").toString();
        }
